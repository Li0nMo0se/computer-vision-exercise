...
class StereoCalibration(CalibrationBase):        
    def calibrate(self, framesPathLeft = 'data/stereo/calibration/left', framesPathRight  = 'data/stereo/calibration/right'):        
        ...
        # objectPointsLeft == objectPointsRight
        # imageSizeLeft == imageSizeRight
        ret = cv.stereoCalibrateExtended(objectPointsLeft,
                                         imgPointsLeft,
                                         imgPointsRight,
                                         None,
                                         None,
        ...
        self.rms = ret[0]
        self.cameraMatrixLeft = ret[1]
        self.distCoeffsLeft = ret[2]
        self.cameraMatrixRight = ret[3]
        self.distCoeffsRight = ret[4]
        self.R = ret[5]
        self.T = ret[6]
        self.perViewErrors = ret[-1]
