...
class MonoRectification:
    ...
    def computeCorrectionMaps(self, alpha = 1.0, xRatio = 1, yRatio = 1):
        ...
        newCameraMatrix, self.roi = cv.getOptimalNewCameraMatrix(self.cameraMatrix, self.distCoeffs, self.imageSize, alpha, newImageSize)
        # Implement initUndistortRectifyMap here
        self.mapx, self.mapy = cv.initUndistortRectifyMap(self.cameraMatrix, self.distCoeffs, None, newCameraMatrix, self.imageSize, cv.CV_32FC1)
